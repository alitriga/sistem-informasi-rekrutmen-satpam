    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="search-box">
                ...
                <a href="create_employee.php" class="btn btn-primary">Tambah</a>
            </div>
            <div class="recent-orders">
                <table>
                    ...
                    <tr>
                        ...
                        <td> <?= $dt['role']; ?> </td>
                        <td>
                            <a href="edit_employee.php?idKaryawan=<?= $dt['idKaryawan']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="delete_employee.php?idKaryawan=<?= $dt['idKaryawan']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach ?>
                    </tbody>
